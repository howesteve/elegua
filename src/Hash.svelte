...
<p>This is reactive: if you change the url manually to a valid tab number, it will change the tab as well.</p>

<p>If you change to another tab and reload (F5) the page, the selected tab/hash will be kept.</p>
